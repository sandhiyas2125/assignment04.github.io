...
As a reminder, the full repository URL is: https://github.com//fullstack-course4
...
When you are continuously working on the assignment, use Browser Sync and keep Chrome open to the Console tab of the Chrome Developer T
